<template>
    <div class="flex flex-col w-full bg-slate-300 py-8">
        ...
        <div class="w-full flex flex-row item-center justify-end px-12">
            ...
            <div class="overflow-x-auto relative shadow-md sm:rounded-lg">
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    <caption class="p-5 text-lg font-semibold text-left text-gray-900 bg-white dark:text-white dark:bg-gray-800">
                        Our products
                        <p class="mt-1 text-sm font-normal text-gray-500 dark:text-gray-400">Browse list of your product, use action button to edit, delete and other action.</p>
                    </caption>
                    ...
                    <tbody>
                        <tr v-for="item in fetchresult" class="bg-white dark:bg-gray-800">
    ...
    export default {
        ...
        mounted(){
            axios.get('http://127.0.0.1:8000/api/product/getrange/1/10')
                .then(result => {
                    console.log(result)
                    this.fetchresult = result.data.message
                })
                .catch(error =>{
                    console.log(error)
                })
